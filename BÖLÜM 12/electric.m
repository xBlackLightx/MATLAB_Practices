...
%      ELECTRIC, by itself, creates a new ELECTRIC or raises the existing
%      singleton*.
%
%      H = ELECTRIC returns the handle to a new ELECTRIC or the handle to
...
%
%      ELECTRIC('Property','Value',...) creates a new ELECTRIC or raises the
...
% Last Modified by GUIDE v2.5 19-Nov-2024 15:56:24
...
function electric_OpeningFcn(hObject, eventdata, handles, varargin)
...
% UIWAIT makes electric wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = electric_OutputFcn(hObject, eventdata, handles) 
